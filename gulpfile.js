...
gulp.task('default', gulp.series('updatePackages', 'updateReadme','photovoltaikChart','photovoltaikchartHTML', 'copyCSS', 'copyImg'));
gulp.task('install', gulp.series('copyHighchartsjs', 'copyHighchartsjs2'));
